# The script below parses XML output files generated by Genome Detective (https://www.genomedetective.com/app/typingtool/rvfv/)
and extracts nucleotide and protein-coding mutations for Rift Valley fever virus (RVFV) genomes (M segment).
# Genome detective only performs M segment lineage classification

# The python script below was applied iteratively to Genome Detective XML outputs from multiple
